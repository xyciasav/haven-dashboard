...
ARG HAVEN_VERSION=0.2.1
ENV HAVEN_VERSION=$HAVEN_VERSION

WORKDIR /app
COPY server.js /app/server.js
COPY index.html styles.css settings.css security.css version.css keycloak.css app.js manifest.webmanifest service-worker.js /opt/haven/site/
