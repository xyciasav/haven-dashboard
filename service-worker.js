const CACHE = 'haven-shell-v0.6.1';
const SHELL = ['/', '/index.html', '/styles.css?v=0.6.1', '/settings.css?v=0.6.1', '/security.css?v=0.6.1', '/version.css?v=0.6.1', '/keycloak.css?v=0.6.1', '/recovery.css?v=0.6.1', '/app-manager.css?v=0.6.1', '/integrations.css?v=0.6.1', '/app.js?v=0.6.1', '/vendor/keycloak.js', '/manifest.webmanifest', '/icons/haven.svg', '/icons/haven-192.png', '/icons/haven-512.png'];
