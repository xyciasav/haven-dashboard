const CACHE = 'haven-shell-v0.7.2';
const SHELL = ['/', '/index.html', '/styles.css?v=0.7.2', '/settings.css?v=0.7.2', '/security.css?v=0.7.2', '/version.css?v=0.7.2', '/keycloak.css?v=0.7.2', '/recovery.css?v=0.7.2', '/app-manager.css?v=0.7.2', '/integrations.css?v=0.7.2', '/app.js?v=0.7.2', '/vendor/keycloak.js', '/manifest.webmanifest', '/icons/haven.svg', '/icons/haven-192.png', '/icons/haven-512.png'];
