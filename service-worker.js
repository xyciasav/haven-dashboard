const CACHE = 'haven-shell-v0.9.0';
const SHELL = ['/', '/index.html', '/styles.css?v=0.9.0', '/settings.css?v=0.9.0', '/security.css?v=0.9.0', '/version.css?v=0.9.0', '/keycloak.css?v=0.9.0', '/recovery.css?v=0.9.0', '/app-manager.css?v=0.9.0', '/integrations.css?v=0.9.0', '/event.css?v=0.9.0', '/app.js?v=0.9.0', '/vendor/keycloak.js', '/manifest.webmanifest', '/icons/haven.svg', '/icons/haven-192.png', '/icons/haven-512.png'];
