const CACHE = 'haven-shell-v0.6.3';
const SHELL = ['/', '/index.html', '/styles.css?v=0.6.3', '/settings.css?v=0.6.3', '/security.css?v=0.6.3', '/version.css?v=0.6.3', '/keycloak.css?v=0.6.3', '/recovery.css?v=0.6.3', '/app-manager.css?v=0.6.3', '/integrations.css?v=0.6.3', '/app.js?v=0.6.3', '/vendor/keycloak.js', '/manifest.webmanifest', '/icons/haven.svg', '/icons/haven-192.png', '/icons/haven-512.png'];
